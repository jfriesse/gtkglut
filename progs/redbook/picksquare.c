...
/*! \file    picksquare.c
    ...
    When the left mouse button is pressed, all squares under 
    the cursor position have their color changed.

    \image   html redbook_picksquare.png
    \include picksquare.c
*/
