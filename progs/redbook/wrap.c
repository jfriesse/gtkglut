...
/*! \file    wrap.c
    ...
    This program demonstrates the wrapping modes, if the texture 
    coordinates fall outside 0.0 and 1.0.

    Pressing the 's' and 'S' keys switch the
