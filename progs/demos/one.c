/*! \file    one.c
    ...
    Hey! This was the original file where freeglut development started.
    See the creation date :)

    \author Copyright (c) 1999 by Pawel W. Olszta<br>
            Written by Pawel W. Olszta, <olszta@sourceforge.net><br>
            <code>Creation date: czw gru  2 11:58:41 CET 1999</code>

    \author Portions Copyright (C) 2004, the OpenGLUT project contributors.<br>
            OpenGLUT branched from freeglut in February, 2004.

    \include demos/One/one.c
*/
...
/*
 * This is the display routine for our sample OpenGLUT windows
 */
...
int main( int argc, char** argv )
{
    ...
    /* Enter the main OpenGLUT processing loop */
    glutMainLoop();

    printf( "glutMainLoop() termination works fine!\n" );

    /* This is never reached in OpenGLUT. Is that good? */
    return EXIT_SUCCESS;
}
