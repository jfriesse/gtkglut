...
struct __gtkglut_tagSFG_StrokeFont
{
    ...
    const __gtkglut_SFG_StrokeChar** Characters;          /* The characters mapping    */
};
...
extern void __gtkglut_unregister_mouse_func(__gtkglut_window_struct *glut_window,int menu_button);

/*Call menu status/state function from window with id window_id and menu with id menu_id*/
extern void __gtkglut_call_menu_status_func(int status,int x,int y,int window_id,int menu_id);
